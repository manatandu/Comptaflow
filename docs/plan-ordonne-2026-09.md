...
| 11 | Salaires en dollars | Source, puis code | 2 à 3 jours | **FAIT (2026-09-24)**, sur la règle tranchée par Manasse faute de texte : « le taux est le taux actuel, il faudra toujours renseigner le taux chaque jour ». Cours USD saisi dans Devises pour le JOUR du calcul (calendrier de Kinshasa), jamais un autre ; absent, le calcul est refusé. Le bulletin fige le cours. L'art. 89 du Code du travail est rappelé à chaque calcul. |
...
| 13 | Droits d'accès plus fins que trois rôles | Code | 1 semaine | **FAIT (2026-09-24)**, tranché par Manasse : deux rôles ajoutés. AIDE_COMPTABLE (saisie au brouillard, sans validation, correction, affectation ni paie ; personnel fermé) et GESTIONNAIRE_PAIE (personnel et bulletins seulement, sans passation au journal, tout le reste fermé par défaut). Trouvé en chemin : la garde du mot de passe provisoire, globale, ne refusait rien en production · déplacée dans JwtAuthGuard. |
| 14 | Consolidation SYSCOHADA (AUDCIF Titres XII et XIII) | Code | 2 semaines | **FAIT (2026-09-24)** pour les quatre tranches décidées par Manasse le 2026-09-24. Tranche 1 **FAITE (2026-09-24)** · périmètre : % contrôle et % intérêt, méthode IG/IP/ME, exclusions de l'art. 96, dates de clôture de l'art. 97, obligation et dispenses (art. 74, 75, 77, 95). Tranche 2 **FAITE (2026-09-24)** · cumul à la fraction (IG, IP), substitution des titres, écart d'acquisition amorti (art. 82), dépréciation jamais reprise, intérêts minoritaires, mise en équivalence, dividendes et comptes réciproques ; balance des filiales par import au canevas de la balance agrégée. Hors tranche 2, dit à l'écran : écarts d'évaluation (tranche 4), dossier OmegaX relié par la console. Résultats internes dans les stocks et immobilisations (art. 86, 4°) **FAITS (2026-09-24)** sur décision de Manasse de s'en remettre à la loi · élimination déclarée, supportée par la vendeuse au pourcentage d'intérêt (lecture de l'art. 85, dite comme telle) ; durée « non limitée » de l'écart non servie (art. 82). Tranche 3a **FAITE (2026-09-24)** · bilan et compte de résultat consolidés au modèle du D4C (ch. XII-8 § 2 et § 3), lus par la résolution individuelle du ch. 7 appliquée à la balance consolidée, colonne N-1 par une seconde consolidation, et note du périmètre (§ 6) avec le secteur d'activité déclaré ; l'état se dit NON PUBLIABLE tant que les impôts différés manquent ou qu'une ligne est à retraiter. Tranche 3b **FAITE (2026-09-24)** · tableau des flux consolidé (§ 4) lu sur les MOUVEMENTS cumulés, balances des filiales importables à six colonnes, flux avec les actionnaires lus sur les comptes propres de la consolidante et par la variation des intérêts minoritaires ; refusé avec ses motifs (entité sans mouvements, capital d'une filiale mouvementé, titres consolidés mouvementés, solde au 13, périmètre qui a bougé depuis N-1) ; variation des capitaux propres (§ 5), bloc N seul. Tranche 4a **FAITE (2026-09-24)** · écarts d'évaluation déclarés par participation (art. 82 « en priorité », amortissable, non amortissable ou réalisé), capitaux propres d'entrée réestimés nets d'impôt ; impôts différés (art. 92) sur les écarts d'évaluation, les marges internes éliminées (taux de la vendeuse) et les décalages et déficits DÉCLARÉS des comptes individuels ; taux déclaré avec sa source par entité, jamais écrit ; actif et passif non compensés ; un champ non déclaré rend l'état non publiable. Tranche 4b **FAITE (2026-09-24)** · provisions réglementées contre-passées sans déclaration (incidence de l'exercice lue sur le 851 et le 861, impôt différé passif), écarts de conversion individuels (478, 479) retraités sur déclaration de la position N-1 et de la provision pour pertes de change (194, 4991, 4997), variation latente au résultat financier ; subventions d'investissement laissées sur leur ligne avec un avertissement. Tranche 4c **FAITE (2026-09-24)** · monnaie de la balance déclarée par entité (monnaie fonctionnelle, justifiée), conversion au cours de clôture aux cours déclarés (capitaux propres au cours historique déclaré en montant), écart de conversion partagé au pourcentage d'intérêt sur sa ligne propre et en colonne de la variation des capitaux propres, écart d'acquisition converti au cours de clôture ; monnaie non déclarée = état non publiable et tableau des flux refusé. Hors de ces tranches, dit à l'écran : méthode temporelle et monnaie hyperinflationniste (ch. XII-4 § 2 et § 4), écarts d'évaluation d'une entité convertie, incidence des cours au tableau des flux (G), variations de pourcentage et entrée en cours d'exercice (ch. XII-7). Filiales : dossier OmegaX relié par la console OU balance importée au canevas de la balance agrégée. |
| 15 | États IFRS en sus du jeu légal (AUDCIF art. 73-1) | Code | 2 à 3 semaines | **EN COURS**, lancé par Manasse le 2026-09-25 · IFRS 18 seul, comptes individuels d'abord. Tranche 1 **FAITE (2026-09-25)** · règles de correspondance déclarées (préfixe → rubrique d'IFRS 18), retraitements déclarés hors du grand livre avec leur fondement, état de la situation financière (courant et non courant, § 96 à 104) et compte de résultat par catégorie (§ 47 à 75, charges par nature), trois colonnes par poste, rapprochement SYSCOHADA → IFRS, comparatif N-1, application anticipée dite (§ C1). Tranche 2 **FAITE (2026-09-25)** · état présentant le résultat global (§ 86 à 95, OCI par retraitement déclaré) et état des variations des capitaux propres (§ 107 à 112, mouvements déclarés, écart non expliqué montré, blocs N et N-1). Tranche 4 **FAITE (2026-09-25)** · première application (IFRS 1) · premier exercice IFRS ou entité déjà adoptante déclarés (§ 3 à 5), état d'ouverture à la date de transition sur le report à-nouveau du comparatif (§ 6, annexe A), ajustements de transition aux capitaux propres seuls (§ 11), trois rapprochements (§ 24 a i, a ii, b) avec reclassements et méthodes séparées des erreurs (§ 26). Tranche 3 **FAITE (2026-09-25)** · état des flux de trésorerie (IAS 7 modifiée par IFRS 18, texte officiel du règlement (UE) 2026/338), méthode indirecte à partir du résultat d'exploitation, bâti sur les flux réels du tableau SYSCOHADA et reclassé (§ 16, § 17, § 20, § 33A, § 34A, § 35), trésorerie IAS 7 avec découverts (§ 8) et effet de change (§ 28) déclarés, rapprochements § 45 et SYSCOHADA → IFRS, blocs N et N-1. Tranche 5 **FAITE (2026-09-25)** · notes (IFRS 18 § 113 à 132, IAS 8 § 6B, 6K, 27A, 27G, 31A, texte officiel du règlement (UE) 2026/338) · déclarations par exercice, reprise N-1 à l'écran, composition des postes et renvois du § 114 calculés, mesures de la performance rapprochées, déclaration de conformité suspendue tant que le jeu n'est pas publiable. Les informations exigées par les AUTRES normes (§ 113 b) ne sont pas servies, et le jeu reste non publiable pour ce motif. Version consolidée, tranche C1 **FAITE (2026-09-25)** · la balance consolidée du D4C projetée sur IFRS 18 (postes rangés par la norme ou déclarés), retraitements consolidés distincts des individuels, participations ne donnant pas le contrôle aux capitaux propres (§ 104 a, IFRS 10 § 22) et résultat net et global répartis (§ 76, § 87), part des minoritaires de chaque retraitement déclarée (IFRS 10 § B94), comparatif N-1. Reste pour le consolidé : tableau des flux, variation des capitaux propres avec la colonne des minoritaires (§ 107 a), notes dont IFRS 12, première application consolidée, écarts de conversion en OCI (IAS 21 § 39 c et § 41). Tables à côté du grand livre, jamais dedans (`docs/decision-multi-classification.md`) |
