 ...
 *    note 34 reprend ;
 *  - AUDCIF Titre VII, fiches COMPTE 49, 59, 67, 77, 83, 84, 85, 86, 87, 88 ·
 *    pour arbitrer chaque rattachement discuté ci-dessous ;
 *  - AUDCIF Titre VIII ch. 30 § 1.4.3 (references/titre-8-ch22-30-…md,
 *    ligne 1440) · seuil des informations sociales et environnementales,
 *    confronté à celui de la note 35 ;
 ...
 *      financières » → ligne « à caractère financier », avec 599 (Titre VII
 *      COMPTE 49 : « 4997 sur opérations financières »). Le moteur Python
 *      du skill le range en exploitation (« 499!4998ᵉ ») : divergence
 *      assumée, le libellé de la ligne et celui du compte concordent ;
 ...
 *    activité principale, fiche R1), au sens de l'article 15.
 */
