...
export const NOTES_SYSCOHADA_1: SpecificationNote[] = [
  ...
  // ======================================================================
  {
    ...
    // de poste à poste) », cadratins du texte remplacés), qui est le même
    // tableau. Le préfixe reproduit
  ...
  // ======================================================================
  {
    ...
    // débit, ligne de balance par ligne de balance. 478 (écart de
    // conversion-actif, BU, note 12) est exclu à la lettre du ch. 7, et 479
    // (BU miroir, DV) l'est aussi comme au poste BJ · voir la rubrique
    // « Autres débiteurs divers » ci-dessous.
    rubriques: [
