...
export const NATURES_RETENUES: NatureRetenue[] = [
  ...
  },
  {
    ...
    reserve:
      "L'assiette n'est pas l'assiette fiscale : c'est la rémunération au sens de l'article 7, litera h du Code du travail, qui exclut les soins de santé, le logement ou son indemnité, les allocations familiales légales, le transport et les frais de voyage ; un plancher au SMIG s'applique (loi, art. 13 al. 3 ; décret, art. 8). LE SMIG EST CHIFFRÉ · décret n° 25/22 du 30 mai 2025, art. 2 : 21 500 FC par jour pour le travailleur MANŒUVRE ORDINAIRE, soit 559 000 FC par mois en appliquant le multiplicateur 26 de son article 7. Le taux monte ensuite de classe en classe jusqu'à 215 000 FC par jour au dernier échelon du cadre de collaboration, suivant la tension salariale des annexes. SUR QUEL MONTANT S'ASSIED LE PLANCHER, LA QUESTION RESTE OUVERTE, et OmegaX ne la tranche pas : l'article 2 fixe le SMIG à 21 500 FC tandis que l'article 3 échelonne son PAIEMENT (14 500 FC de la paie de mai 2025 à celle de décembre 2025, 21 500 FC ensuite). Les annexes du décret, elles, assoient les allocations familiales et la contre-valeur du logement sur le montant PAYÉ (537,04 FC de mai à décembre 2025, soit 14 500/27) · elles ne disent rien du plancher d'assiette sociale, qui relève d'un autre texte. Le point est à confirmer auprès de la CNSS avant d'en tirer une assiette. Déclaration mensuelle unique impôts et cotisations au guichet unique (arrêté interministériel du 12 mai 2015) ; télédéclaration obligatoire au-delà de vingt-cinq travailleurs (arrêté n° 146/2018, art. 24).",
  },
  {
    cle: 'inpp',
    ...
    reserve:
      "DATE D\'EFFET · les deux arrêtés entrent en vigueur À LA DATE DE LEUR SIGNATURE, chacun par son article 3. Un exercice à cheval sur le 24 septembre 2025 porte donc les DEUX barèmes, mois par mois · même discipline que l\'ONEM, dont le taux a changé la veille. Avant le 14 février 2006, c\'est l\'arrêté n° 12/MTPS/FIN&BU/064/03 du 28 mars 2003 qui régissait ; son taux n\'est PAS reconstitué ici, le texte n\'ayant pas été lu · seule son existence est attestée, par le visa de celui de 2006. " +
      ...
      "TRANCHE D\'EFFECTIF · le taux dépend d\'abord de la NATURE de l\'employeur (public ou privé), puis, pour le privé seulement, de la tranche d\'effectif · jamais d\'un chiffre d\'affaires ni d\'une masse salariale. Renseignez l\'effectif permanent dans Structure > Paramètres du dossier pour que le registre puisse rappeler le taux applicable au vôtre. Le logiciel ne LIQUIDE rien : il recense ce que votre comptabilité porte sur le compte 4334.",
  },
  {
    cle: 'onem',
