...
export const NATURES_RETENUES: NatureRetenue[] = [
  ...
  },
  {
    ...
    reserve:
      "L'assiette n'est pas l'assiette fiscale : c'est la rémunération au sens de l'article 7, litera h du Code du travail, qui exclut les soins de santé, le logement ou son indemnité, les allocations familiales légales, le transport et les frais de voyage ; un plancher au SMIG s'applique (loi, art. 13 al. 3 ; décret, art. 8). LE SMIG EST CHIFFRÉ DEPUIS LE 30 MAI 2025 · 21 500 FC par jour pour le manœuvre ordinaire (décret n° 25/22 du 30 mai 2025, art. 2), soit 559 000 FC par mois en appliquant le multiplicateur 26 de son article 7. ATTENTION AU PIÈGE · l'article 3 du même décret échelonne le PAIEMENT (14 500 FC à partir de la paie de mai 2025, 21 500 FC à partir de celle de janvier 2026), il ne rabaisse pas le SMIG : le plancher d'assiette reste assis sur les 21 500 FC de l'article 2. Le calculer sur le payable du mois minorerait l'assiette pendant huit mois. Déclaration mensuelle unique impôts et cotisations au guichet unique (arrêté interministériel du 12 mai 2015) ; télédéclaration obligatoire au-delà de vingt-cinq travailleurs (arrêté n° 146/2018, art. 24).",
  },
  {
    cle: 'inpp',
