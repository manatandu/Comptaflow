...
import { EtatsPersonnalisesController } from './etats-personnalises.controller';
...
@Module({
  ...
  controllers: [EtatsPersonnalisesController],
  providers: [EtatsPersonnalisesService],
})
export class EtatsPersonnalisesModule {}
