...
export const LEXIQUE = {
  ...
  resultatFiscal: {
    ...
    texte:
      "Le bénéfice imposable est l'excédent des produits sur les charges « en application de la législation comptable, sous réserve des dispositions fiscales contraires ». Il part donc du résultat comptable, auquel s'ajoutent les charges que le fisc n'admet pas (réintégrations) et dont se retranchent les produits qu'il n'impose pas (déductions), puis les déficits des trois exercices précédents. L'impôt sur les sociétés est de 30 % de ce résultat, sans pouvoir être inférieur à 1 % du chiffre d'affaires déclaré. Une entreprise individuelle ou un entreprenant relève d'un autre régime, commandé par son chiffre d'affaires : forfait en dessous de 25 millions de FC, 1 % ou 2 % du chiffre d'affaires jusqu'à 300 millions, régime réel au-delà. L'exemption d'une entité à but non lucratif n'est pas la même selon son fondement : une association régulièrement constituée l'obtient par le point 3 de l'article 5, tandis qu'un établissement d'utilité publique ou une ONG relève du point 5, dont l'arrêté n° 007/CAB/MIN/FINANCES/2025 subordonne le bénéfice à une ATTESTATION D'EXEMPTION et à quatre conditions cumulatives de fond. Le manquement à l'une d'elles rend l'impôt dû au titre de l'exercice concerné : l'exemption se vérifie, elle ne se présume pas.",
    source: 'Loi n° 23/053 du 30 novembre 2023, art. 5, 9, 51, 56, 57, 107 à 128 ; arrêté ministériel n° 007/CAB/MIN/FINANCES/2025 du 19 février 2025',
  },
  notesAnnexes: {
    titre: 'Notes annexes',
    texte:
