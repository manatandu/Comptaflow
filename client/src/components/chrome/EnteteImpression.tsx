...
export function BoutonImprimer({ libelle = 'Imprimer' }: { libelle?: string }) {
  return (
    <button
      ...
      className="ecran-seul flex items-center gap-1.5 border border-border rounded-[3px] bg-surface px-3 py-1.5 text-[11.5px] font-bold hover:bg-surface-alt"
    >
...
export function BlocCertification() {
  ...
  return (
    <section className="impression-seul mt-6 border border-black p-3 text-[11.5px]">
