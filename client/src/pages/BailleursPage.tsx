...
export function BailleursPage() {
  ...
  return (
    <div className="p-2">
      ...
      {!jeuProjet && (
        <p className="text-[12px] text-text-dim mb-2.5">
      ...
      {erreur && !afficherFormulaire && (
        <div className="text-[12.5px] text-danger bg-danger-soft border border-danger/30 px-2.5 py-1.5 mb-3 max-w-[900px]">{erreur}</div>
      )}

      {!bailleurs && <div className="text-[12.5px] text-text-dim">Chargement…</div>}
      ...
      {bailleurs && (
        ...
        >
          ...
          {bailleurs.length === 0 && <div className="px-4 py-3 text-[12.5px] text-text-dim">Aucun bailleur créé.</div>}
          {bailleurs.map((b, i) => (
            <div
              key={b.id}
            ...
            >
              <span className="font-mono text-[12.5px]">{b.code}</span>
            ...
            {comptesEligibles.map((c, i) => (
              ...
              >
                ...
                <select
                  ...
                  disabled={!estAdmin}
                  className="border border-border-dark px-2 py-1 text-[12px] disabled:opacity-60"
                >
