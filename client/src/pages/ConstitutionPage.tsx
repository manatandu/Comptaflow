...
export function ConstitutionPage() {
  ...
  if (!p) return <div className="p-3 text-[12.5px] text-text-dim">Chargement…</div>;
  ...
  return (
    <div className="p-2 max-w-[980px]">
      ...
      <section className="border border-border bg-surface px-3.5 py-2.5 mb-2.5">
        <h2 className="text-[12.5px] font-bold mb-1.5">Trois fondements, et ils ne se valent pas</h2>
        ...
        <section key={e.cle} className="border border-border bg-surface px-3.5 py-2.5 mb-2.5">
          ...
          {e.pieces.length > 0 && (
            <ul className="mt-2 space-y-1.5">
              {e.pieces.map((piece) => (
                <li key={piece.cle} className="text-[12px] border-t border-border/50 pt-1.5">
                  <div className="flex items-baseline justify-between gap-3 flex-wrap">
