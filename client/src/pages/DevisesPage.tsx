      ...
      <div className="grid grid-cols-1 xl:grid-cols-[380px_1fr] gap-2.5 items-start">
          ...
          {peutEcrire && devises.length > 0 && (
            <form onSubmit={poserCours} className="bg-surface border border-border rounded-[10px] shadow-posee overflow-hidden">
              ...
              <div className="p-3 flex flex-col gap-2">
                ...
                <p className="text-[11px] text-text-dim leading-[1.5]">
          ...
          <section className="bg-surface border border-border rounded-[10px] shadow-posee overflow-hidden">
            ...
            {devises.map((d) => (
              <div key={d.id} className="px-3 py-2 border-b border-border/40">
                ...
                {d.cours.length > 0 ? (
                  <div className="text-[12px] text-text-dim mt-0.5 font-mono">
                    dernier cours {montant(d.cours[0].cours)} au {jour(d.cours[0].date)}
                  </div>
                ) : (
                  <div className="text-[12px] text-warning mt-0.5">aucun cours coté</div>
                )}
              </div>
            ))}
            {devises.length === 0 && (
              <div className="px-3 py-3 text-[12.5px] text-text-dim italic">
        ...
        >
          <div className="px-3 py-2 bg-chrome-alt border-b border-border flex items-center justify-between">
            <span className="text-[12px] font-bold">Réévaluation à la clôture</span>
            <span className="flex items-center gap-2">
              <input
                ...
                className="border border-border rounded-[6px] px-2 py-1 text-[12px] font-mono"
              />
              <label
          ...
          {rapport && (
            <>
              {rapport.avertissements.length > 0 && (
                <div className="mx-3 mt-3 text-[12.5px] text-warning bg-warning-soft border border-warning/30 rounded-[6px] px-2.5 py-2 leading-[1.55]">
              ...
              {rapport.positionGlobaleRetenue && rapport.provisionSansPositionGlobale > rapport.provision && (
                <div className="mx-3 mt-3 text-[12.5px] text-text-dim bg-chrome-alt border border-border rounded-[6px] px-2.5 py-1.5 leading-[1.55]">
              ...
              {rapport.coursManquants.length > 0 && (
                <div className="mx-3 mt-3 text-[12.5px] text-warning bg-warning-soft border border-warning/30 rounded-[6px] px-2.5 py-1.5">
              ...
              {rapport.positions.map((p) => (
                <div
                  ...
                  className="grid grid-cols-[110px_1fr_60px_110px_90px_130px_130px_120px] min-w-[980px] gap-2 px-3 py-1 text-[12.5px] border-b border-border/40"
                >
          ...
          {reevaluations.length > 0 && (
            <div className="border-t border-border">
              ...
              {reevaluations.map((r) => (
                <div
                  key={r.id}
                  className="grid grid-cols-[130px_1fr_200px] min-w-[520px] gap-2 px-3 py-1.5 text-[12.5px] items-center border-b border-border/40"
                >
              ...
              <p className="px-3 py-2 text-[11px] text-text-dim leading-[1.55]">
