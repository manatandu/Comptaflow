    ...
    <div className="p-2">
      ...
      <div className="ecran-seul mb-1.5 max-w-[1240px]">
        <div className="flex items-center justify-end gap-2">
          ...
          <Aide
            ...
            texte="« Faire le suivi des faiblesses relevées lors de l’audit précédent » (CPCC), parmi les travaux de l’inventaire documentaire, conduit selon la méthode de l’ISA 265. Ce n’est pas un audit et aucune opinion sur les états financiers n’en sort."
            source="CPCC · ISA 265"
          />
        </div>
      </div>
      ...
      {creation && (
        <div className="border border-border bg-surface px-3.5 py-2.5 mb-2.5 max-w-[1240px]">
          <div className="text-[11.5px] font-semibold mb-1.5">Ouvrir un registre</div>
          <div className="flex flex-wrap gap-2 items-end">
            ...
            <label className="text-[11px] text-text-dim">
              <span className="flex items-center gap-1">
                Origine
                <Aide
                  titre="Origine du registre"
                  texte="En mode « recommandation reçue », OmegaX est le porte-documents de la direction : il range et il suit. La qualification portée dans la lettre est recopiée telle quelle, et le cabinet ne la refait pas. En révision interne, le cabinet constate sur son propre travail de tenue. La qualification en « significative » est un acte de jugement séparé (§ 6 b), jamais une conséquence d’un montant."
                  source="ISA 265 § 6 b)"
                />
              </span>
              <select
                ...
                className="block border border-border bg-surface px-2 py-[3px] text-[11.5px] min-w-[220px]"
              >
      ...
      <div className="flex gap-2.5 max-w-[1400px] items-start">
        <div className="border border-border bg-surface min-w-[240px] max-w-[280px]">
          ...
          {registres?.map((r) => (
            ...
            >
              <div className="text-[11.5px] font-semibold leading-tight">{r.libelle}</div>
            ...
            <>
              ...
              {s && s.total > 0 && (
                <div className="border border-border bg-surface px-3.5 py-2 mb-2">
                  ...
                  {s.significativesSansEcrit > 0 && (
                    <div className="text-[11px] text-danger mt-1 flex items-center gap-1.5">
                      {s.significativesSansEcrit} faiblesse(s) significative(s) jamais communiquée(s) par écrit
                      <Aide
                        titre="Communication écrite"
                        texte="« The auditor shall communicate IN WRITING significant deficiencies […] on a timely basis »."
                        source="ISA 265 § 9"
                      />
                    </div>
                  )}
                  {s.significativesAReporter > 0 && (
                    <div className="text-[11px] text-warning mt-1 flex items-center gap-1.5">
                      <span>
                        ...
                        {s.referencesAReporter.length > 0 && ` (${s.referencesAReporter.join(', ')})`}
                      </span>
                      <Aide
                        titre="Report des significatives"
                        texte="Les avoir déjà communiquées « does NOT eliminate the need to repeat the communication if remedial action has not yet been taken »."
                        source="ISA 265 § A17"
                      />
                    </div>
                  )}
              ...
              {ajout && detail.statut === 'OUVERT' && (
                <div className="border border-border bg-surface px-3.5 py-2.5 mb-2">
                  <div className="text-[11.5px] font-semibold mb-1.5">Ajouter une faiblesse</div>
                  <div className="flex flex-wrap gap-2 items-end mb-1.5">
                    <label className="text-[11px] text-text-dim">
                      ...
                      <input
                        ...
                        placeholder="F-01"
                        className="block border border-border bg-surface px-2 py-[3px] text-[11.5px] w-[90px]"
                      />
                    </label>
