    ...
    return (
      <div className="p-2 max-w-[760px]">
        <section className="border border-border bg-surface px-3.5 py-2.5">
          <h2 className="text-[12.5px] font-bold mb-1.5">Ce dossier n'est pas concerné</h2>
  ...
  return (
    <div className="p-2 max-w-[980px]">
      ...
      <section className="border border-border bg-surface px-3.5 py-2.5 mb-2.5">
        <h2 className="text-[12.5px] font-bold mb-1.5">Ce que cet accord n'ouvre PAS</h2>
        <p className="text-[12px] text-text-dim leading-[1.6]">
      ...
      <section className="border border-border bg-surface px-3.5 py-2.5 mb-2.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <label className="text-[12px]">
            Référence
            <input className="w-full border border-border px-1.5 py-1 text-[12px]" value={reference} onChange={(e) => setReference(e.target.value)} />
          </label>
          <label className="text-[12px]">
            Date de signature
            <input type="date" className="w-full border border-border px-1.5 py-1 text-[12px]" value={dateSignature} onChange={(e) => setDateSignature(e.target.value)} />
          </label>
          <label className="text-[12px]">
            Durée (années)
            <input type="number" className="w-full border border-border px-1.5 py-1 text-[12px]" value={dureeAnnees} onChange={(e) => setDureeAnnees(e.target.value === '' ? '' : Number(e.target.value))} />
          </label>
          <label className="text-[12px]">
            Préavis de dénonciation (mois)
            <input type="number" className="w-full border border-border px-1.5 py-1 text-[12px]" value={preavisMois} onChange={(e) => setPreavisMois(e.target.value === '' ? '' : Number(e.target.value))} />
          </label>
          ...
          <label className="text-[12px]">
            ...
            <input className="w-full border border-border px-1.5 py-1 text-[12px]" value={representationRdc} onChange={(e) => setRepresentationRdc(e.target.value)} />
          </label>
        </div>
      ...
      <section className="border border-border bg-surface px-3.5 py-2.5">
        ...
        {etat.accords.length === 0 ? (
          <p className="text-[12px] text-text-dim">Aucun accord-cadre enregistré.</p>
        ) : (
